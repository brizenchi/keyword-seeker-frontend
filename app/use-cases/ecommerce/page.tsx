      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6 mb-16">
            <Badge className="bg-[#0F1635] text-orange-400 border-[#1E2650] px-4 py-1.5 backdrop-blur-sm">
              For E-commerce Sellers
            </Badge>
            <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Find Trending Products & Optimize Listings
            </h1>
            <p className="text-lg text-[#8B92B3] max-w-2xl mx-auto font-light">
              Discover profitable products, optimize your listings, and increase sales with data-driven keyword research.
            </p>
            <Link href="/pricing">
          ...
          <Card className="p-8 border-[#1E2650] bg-[#0F1635]/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-white font-bold" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                <ShoppingCart className="h-6 w-6 text-[#0080FF]" />
                Coming Soon
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-[#8B92B3]">
                This use case page is currently being developed. Check back soon for comprehensive guides on using NichePop for e-commerce keyword research.
              </p>
            </CardContent>
          </Card>
        </div>
